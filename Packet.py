...
class FlowRequest:
    def __init__(self, source_id, des_id, node_id, seq,time):
...
class FlowReply:
    def __init__(self, source_id, des_id, route, node_id, seq,dur):
        self.source_id = source_id
        self.des_id = des_id
        self.route = route
        self.seq = seq
...
class FlowError:
    def __init__(self, source_id, des_id, error_id, time, source_seq, error_seq, s_time, next_hop):
        self.source_id = source_id
        self.des_id = des_id
...
class geo_FlowRequest:
    def __init__(self, source_id, des_list, node_id, seq, time):
        self.source_id = source_id
        self.des_list = des_list
        self.seq = seq
        self.node_id = node_id
...
class RoutingTable:
    def __init__(self, source_id, des_id, next_hop_id, state, node_id, seq, dur):
        self.source_id = source_id
        self.des_id = des_id
